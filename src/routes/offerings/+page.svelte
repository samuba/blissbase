...
<div class="mx-auto w-full max-w-5xl mb-2 sm:mb-4">
	<div class="card bg-base-100 lg:rounded-box mb-4 w-full rounded-none p-6 shadow">
		<header class="mb-6 flex flex-col gap-4 sm:flex-row sm:justify-between items-start">
			<div class="max-w-2xl">
				<div class="flex items-center gap-4">
					...
					<div class="flex flex-col justify-center">
						<h1 class="text-2xl font-bold -mt-0.5">Angebote</h1>
		...
		<div class="flex flex-col gap-4 sm:flex-row sm:items-end">
			<div class="flex w-full max-w-xs flex-col gap-1.5">
				<span id="offering-location-label" class="text-sm font-medium hidden sm:block">Ort auswählen</span>
				<Select
			...
			<div class="flex w-full max-w-xs flex-col gap-1.5">
				<label for="offering-search" class="text-sm hidden sm:block font-medium">Suche</label>
				<div class="relative">
	...
	<div class="px-4 lg:px-0">
		{#if filteredOfferings.length}
			<div class="grid gap-4 md:grid-cols-2">
				<div class="border-dashed border-2 border-primary rounded-box p-4 bg-primary/20 flex flex-col gap-2">
					<span class="md:card-title mt-2 text-primary-content">Was willst du der Community geben?</span>
					...
					<a href={routes.newOffering()} class="btn btn-primary w-fit mt-2"> 
						<i class="icon-[ph--plus] size-5"></i>
						Angebot erstellen 
					</a>
				</div>
		...
		<section class="card bg-base-100 mt-4 shadow-sm">
			<div class="card-body flex flex-col gap-4 sm:gap-6 sm:flex-row sm:items-center ">
				<div>
					<h2 class="card-title">
