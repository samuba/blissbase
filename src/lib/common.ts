...
export const dialogContentExitAnimationClasses = 'backface-visibility-hidden will-change-transform data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95';
...
export const dialogOverlayExitAnimationClasses = 'backface-visibility-hidden will-change-[opacity] data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=closed]:duration-150 data-[state=closed]:ease-in';
