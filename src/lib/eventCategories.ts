...
export const eventCategories: EventCategory[] = [
	{
		...
		tags: [
			...
			{
				slug: `dance-impro`,
				get label() { /* @wc-include */ return `Tanzimpro`; }
			},
			{
				slug: `zouk`,
	...
	},
	{
		...
		tags: [
			...
			},
			{
				...
				get label() { /* @wc-include */ return `Rebirthing Breathwork`; }
			},
			{
				slug: `wim-hof-method`,
			...
			{
				slug: `holotropicstyle-breathwork`,
	...
	},
	{
		...
		tags: [
			...
			},
			{
				...
				get label() { /* @wc-include */ return `Sacred Sexuality`; }
			},
			{
	...
	},
	{
		...
		tags: [
			...
			{
				slug: `singing-circles`,
				get label() { /* @wc-include */ return `Singkreise`; }
			},
			{
				slug: `medicine-music`,
			...
			{
				slug: `drum-circles`,
				get label() { /* @wc-include */ return `Trommelkreise`; }
			},
			{
				slug: `ukulele`,
	...
	},
	{
		...
		tags: [
			...
			},
			{
				...
				get label() { /* @wc-include */ return `HSP (Hochsensible Person)`; }
			},
			{
	...
	},
	{
		...
		tags: [
			...
			{
				slug: `card-reading`,
				get label() { /* @wc-include */ return `Kartenlegung`; }
			},
			{
				slug: `i-ching`,
	...
	},
	{
		...
		tags: [
			...
			{
				slug: `full-moon-ceremony`,
				get label() { /* @wc-include */ return `Vollmondzeremonie`; }
			},
			{
				slug: `new-moon-ceremony`,
				get label() { /* @wc-include */ return `Neumondzeremonie`; }
			},
			{
				slug: `temazcal`,
...
export function resolveTagIdsForCategories(args: {
	...
	for (const categorySlug of args.categorySlugs) {
		...
		for (const tag of category.tags) mappedSlugs.add(tag.slug);
	}
