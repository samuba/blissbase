/**
 * Scrapes yoga/activity occurrences from vortexapp.dev via its Xano API
 * (Ubud, next 14 days). Authenticates first, then maps each occurrence.
 *
 * Usage:
 *   bun run scripts/scrape-vortexapp.ts
 */
